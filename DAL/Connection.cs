...
namespace hospitalmanagement.DAL
{
    class Connection
    {
        public SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\skaya\Desktop\LAST_ONE\hospitaldatabase.mdf;Integrated Security=True");
